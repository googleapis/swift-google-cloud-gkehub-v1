...
func sample(
  ...
  let poller = try await client.deleteMembershipRbacroleBinding(
    withPolling: DeleteMembershipRBACRoleBindingRequest()
      .with {
        $0.name =
  ...
  static func main() async throws {
    do {
      ...
      try await sample(
        ...
        scopeId: "[placeholder]", rbacrolebindingId: "[placeholder]")
    } catch {
      print("Error: \(error)")
    }
  }

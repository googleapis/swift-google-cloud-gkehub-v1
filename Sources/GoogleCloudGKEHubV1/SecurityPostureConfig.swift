  ...
  Sendable
{
  ...
  public var mode: SecurityPostureConfig.Mode = SecurityPostureConfig.Mode()
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(SecurityPostureConfig.Mode.self, forKey: .mode) {
      self.mode = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.SecurityPostureConfig"
  }

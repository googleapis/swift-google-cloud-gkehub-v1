...
/// resource.
public struct RBACRoleBindingLifecycleState: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Output only. The current state of the rbacrolebinding resource.
  public var code: RBACRoleBindingLifecycleState.Code = RBACRoleBindingLifecycleState.Code()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `RBACRoleBindingLifecycleState`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RBACRoleBindingLifecycleState().with { $0.code = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      RBACRoleBindingLifecycleState.Code.self, forKey: .code)
    {
      self.code = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.RBACRoleBindingLifecycleState"
  }

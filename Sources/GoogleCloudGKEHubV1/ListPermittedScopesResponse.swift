...
public struct ListPermittedScopesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListPermittedScopesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListPermittedScopesResponse().with { $0.scopes = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([Scope].self, forKey: .scopes) {
      self.scopes = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.ListPermittedScopesResponse"
  }
...
extension ListPermittedScopesResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Scope] {
    return self.scopes
  }

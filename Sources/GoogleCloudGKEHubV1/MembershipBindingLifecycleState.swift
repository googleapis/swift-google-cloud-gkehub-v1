...
public struct MembershipBindingLifecycleState: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Output only. The current state of the MembershipBinding resource.
  public var code: MembershipBindingLifecycleState.Code = MembershipBindingLifecycleState.Code()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `MembershipBindingLifecycleState`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = MembershipBindingLifecycleState().with { $0.code = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      MembershipBindingLifecycleState.Code.self, forKey: .code)
    {
      self.code = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.MembershipBindingLifecycleState"
  }

...
public struct ListMembershipBindingsRequest: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMembershipBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMembershipBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.ListMembershipBindingsRequest"
  }

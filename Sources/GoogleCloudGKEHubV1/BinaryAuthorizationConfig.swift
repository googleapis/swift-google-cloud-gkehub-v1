...
public struct BinaryAuthorizationConfig: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Optional. Mode of operation for binauthz policy evaluation.
  public var evaluationMode: BinaryAuthorizationConfig.EvaluationMode =
  ...
  ///
  /// ```
  /// let value = BinaryAuthorizationConfig().with { $0.evaluationMode = ... }
  /// ```
  ...
  public struct PolicyBinding: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
  ...
  public enum EvaluationMode: Codable, Equatable, Sendable {
    ...
    public var stringValue: Swift.String? {
      ...
      case .policyBindings: return "POLICY_BINDINGS"
    ...
    public init(stringValue: Swift.String) {
      ...
      case "POLICY_BINDINGS": self = .policyBindings

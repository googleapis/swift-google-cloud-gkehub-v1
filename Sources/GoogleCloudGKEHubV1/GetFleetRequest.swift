...
public struct GetFleetRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetFleetRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetFleetRequest().with { $0.name = ... }
  /// ```

...
public struct ListScopeRBACRoleBindingsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListScopeRBACRoleBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListScopeRBACRoleBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.ListScopeRBACRoleBindingsRequest"
  }

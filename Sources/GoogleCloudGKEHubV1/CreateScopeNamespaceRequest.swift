...
public struct CreateScopeNamespaceRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var scopeNamespaceId: Swift.String = Swift.String()
  ...
  ///
  /// ```
  /// let value = CreateScopeNamespaceRequest().with { $0.parent = ... }
  /// ```

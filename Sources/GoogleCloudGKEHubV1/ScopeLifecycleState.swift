...
public struct ScopeLifecycleState: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Output only. The current state of the scope resource.
  public var code: ScopeLifecycleState.Code = ScopeLifecycleState.Code()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `ScopeLifecycleState`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ScopeLifecycleState().with { $0.code = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(ScopeLifecycleState.Code.self, forKey: .code) {
      self.code = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.ScopeLifecycleState"
  }

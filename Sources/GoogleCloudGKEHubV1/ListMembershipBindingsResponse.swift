  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let membershipBindings = CodingKeys(stringValue: "membershipBindings")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [MembershipBinding].self, forKey: .membershipBindings)
    {
      self.membershipBindings = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.membershipBindings, forKey: .membershipBindings)

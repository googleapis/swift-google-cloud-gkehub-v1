...
public struct FleetLifecycleState: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// Output only. The current state of the Fleet resource.
  public var code: FleetLifecycleState.Code = FleetLifecycleState.Code()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleWKT._UnknownFields = .init()

  /// Initialize a new instance of `FleetLifecycleState`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FleetLifecycleState().with { $0.code = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(FleetLifecycleState.Code.self, forKey: .code) {
      self.code = value
    }

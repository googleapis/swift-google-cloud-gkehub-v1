...
/// List of Scopes.
public struct ListScopesResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  /// The list of Scopes
  ...
  /// Initialize a new instance of `ListScopesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListScopesResponse().with { $0.scopes = ... }
  /// ```
...
extension ListScopesResponse: GoogleGax._PaginatedResponse {

...
public struct NamespaceLifecycleState: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  Sendable
{
  /// Output only. The current state of the Namespace resource.
  public var code: NamespaceLifecycleState.Code = NamespaceLifecycleState.Code()

  @_spi(GoogleCloudInternal) public var _unknownFields: GoogleCloudWKT._UnknownFields = .init()

  /// Initialize a new instance of `NamespaceLifecycleState`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = NamespaceLifecycleState().with { $0.code = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(NamespaceLifecycleState.Code.self, forKey: .code) {
      self.code = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.NamespaceLifecycleState"
  }

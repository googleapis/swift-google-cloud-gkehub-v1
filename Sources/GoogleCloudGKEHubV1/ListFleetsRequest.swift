...
public struct ListFleetsRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListFleetsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListFleetsRequest().with { $0.parent = ... }
  /// ```

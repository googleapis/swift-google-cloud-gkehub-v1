...
public struct ListMembershipRBACRoleBindingsRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListMembershipRBACRoleBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListMembershipRBACRoleBindingsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.gkehub.v1.ListMembershipRBACRoleBindingsRequest"
  }

...
public struct DeleteFleetRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteFleetRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteFleetRequest().with { $0.name = ... }
  /// ```

...
let package = Package(
  ...
  dependencies: [
    ...
    localOrRemotePackage(
      ...
      path: "generated/swift-google-cloud-gkehub-configmanagement-v1",
      from: "0.2.0"
    ),
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-google-cloud-gkehub-multiclusteringress-v1",
      path: "generated/swift-google-cloud-gkehub-multiclusteringress-v1",
      from: "0.2.0"
    ),
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-google-cloud-gkehub-rbacrolebindingactuation-v1",
      path: "generated/swift-google-cloud-gkehub-rbacrolebindingactuation-v1",
      from: "0.2.0"
    ),
    localOrRemotePackage(
